...
const styles = StyleSheet.create({
  ...
  sessionsLabel: { fontSize: 12, fontFamily: 'PoppinsBold', letterSpacing: 0.5, marginBottom: 4 },
  // Session card
  ...
  sessionPlayer: { fontSize: 13, fontFamily: 'PoppinsBold', flex: 1 },
  sessionPlayerRight: { fontSize: 13, fontFamily: 'PoppinsBold', flex: 1, textAlign: 'right' },
  sessionFrames: { fontSize: 20, fontFamily: 'PoppinsBold', marginHorizontal: 8 },
